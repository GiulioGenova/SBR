...
ui <- dashboardPage(#useShinyjs(),
  ...
  dashboardBody(#tags$style(type = "text/css", "#map {height: calc(100vh - 80px) !important;}"),
    #tags$style(type = "text/css", "#map2 {height: 100% !important;}"),
    #tags$style(type = "text/css", "#plotall {height: calc(100vh - 200px) !important;}"),
    #tags$style(type = "text/css", "#mapIrrig {height: 100% !important;}"),
    tags$head(
    ...
    tabItems(
      ...
      tabItem(tabName = "Data",
              ...
              fluidRow(
                ...
                box(width = 2,selectInput("round",label = h4("Time aggregation"),choices = list("hour","day","month","year"))),#,"5 min","week",
      ...
      tabItem(tabName = "irrigApple",
              fluidRow(
                column(width = 5,
                       ...
                       box(
                         width=12,
                         #conditionalPanel(condition="output.irrigAdvise",
                ...
                column(
                  ...
                  box(
                    id="box1",
                    #tags$style(type = "text/css", ".box-body {height:70vh}"),
